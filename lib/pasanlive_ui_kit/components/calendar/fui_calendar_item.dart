...
class _FUICalendarItemState extends State<FUICalendarItem> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.description != null) {
      contentList.add(UISpacer.vSpace15);
  ...
  _buildHeader() {
    ...
    cList.add(UISpacer.vSpace5);
    cList.add(_buildHeaderEventName());
    cList.add(UISpacer.vSpace9);
    cList.add(_buildHeaderTime());

    if (widget.venue != null) {
      cList.add(UISpacer.vSpace3);
      cList.add(_buildHeaderVenue());
    }

    cList.add(UISpacer.vSpace7);

    UIColumn headerCol = UIColumn(
      children: cList,
    );
...
class _FUICalendarAllDayItemState extends State<FUICalendarAllDayItem> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.venue != null) {
      col1List.add(UISpacer.vSpace10);
    ...
    if (widget.description != null) {
      if (col2List.isNotEmpty) {
        col2List.add(UISpacer.vSpace15);
      }
