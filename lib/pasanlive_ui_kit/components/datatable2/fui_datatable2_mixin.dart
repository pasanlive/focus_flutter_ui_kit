...
mixin FUIDataTable2Mixin {
  ...
  TextStyle discernHeadingTextStyle(BuildContext context, UIColorScheme? fuiColorScheme, FUIDataTable2Size? fuiDataTable2Size) {
  ...
  CheckboxThemeData discernHeadingCheckboxTheme(BuildContext context, UIColorScheme? fuiColorScheme, FUIDataTable2Size? fuiDataTable2Size) {
  ...
  CheckboxThemeData discernRowCheckboxTheme(BuildContext context, UIColorScheme? fuiColorScheme) {
    final UIThemeCommonColors fuiColors = context.theme.fuiColors;
    final FUIDataTable2Theme fuiDataTable2Theme = context.theme.fuiDataTable2;
