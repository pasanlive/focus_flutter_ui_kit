...
class _FUIDataTable2State extends State<FUIDataTable2> with FUIDataTable2Mixin, UIColorMixin {
  /// Essentials
...
class _FUIPaginatedDataTable2State extends State<FUIPaginatedDataTable2> with FUIDataTable2Mixin, UIColorMixin {
  /// Essentials
  late UIThemeCommonColors fuiColors;
  late FUIDataTable2Theme fuiDataTable2Theme;
...
class _FUIAsyncPaginatedDataTable2State extends State<FUIAsyncPaginatedDataTable2> with FUIDataTable2Mixin, UIColorMixin {
  /// Themes
  late UIThemeCommonColors fuiColors;
  late FUIDataTable2Theme fuiDataTable2Theme;
