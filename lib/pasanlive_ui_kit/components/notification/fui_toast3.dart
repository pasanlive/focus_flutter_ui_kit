...
class FUIToast3 with FUIToastMixin, UIColorMixin {
  ...
  Widget _buildToastContainer(UIColorScheme? fuiColorScheme, FUIToastDecoBarPosition? fuiToastDecoBarPosition, Widget child) {
